...
import moe_project.spring.domain.enums.Ad;
import moe_project.spring.domain.enums.LoginStatus;
import moe_project.spring.domain.enums.Marketing;
import moe_project.spring.domain.enums.Provider;
